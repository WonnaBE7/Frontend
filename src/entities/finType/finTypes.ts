...
export const finTypeMonth = [
  { label: '가족중심형', descript: '2024.01' },
  { label: '경험소비형', descript: '2024.02' },
  { label: '공격투자형', descript: '2024.03' },
  { label: '균형 성장형', descript: '2024.04' },
  { label: '느긋한 관망형', descript: '2024.05' },
  { label: '루틴러형', descript: '2024.06' },
  { label: '무계획형', descript: '2024.07' },
  { label: '미래계획형', descript: '2024.08' },
  { label: '새싹 투자자형', descript: '2024.09' },
  { label: '소확행형', descript: '2024.10' },
