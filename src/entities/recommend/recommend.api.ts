...
import { mockCardDetail, mockCurrentProducts, mockInsuranceDetail, mockSavingsDetail, mockSavingsRecommendation, mockCardDetailPage, mockInsuranesDetailPage, mockSavingsDetailPage } from "./recommend.mock";
