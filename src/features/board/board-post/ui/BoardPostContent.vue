<template>
    <Card class="bg-white border border-gray-150">
      ...
      <Typography type="M_12_140" class="text-gray-600 mt-4 w-full border-b border-gray-150 pb-4">{{ post.content }}</Typography>
      <div class="flex flex-row w-full items-center justify-between mt-4">
        <div class="flex flex-row items-center">
          <HeartIcon
            :class="[
              'w-4 h-4 transition mr-2',
          ...
          <BookmarkIcon
              :class="[
              'w-5 h-5 cursor-pointer transition mr-2',
