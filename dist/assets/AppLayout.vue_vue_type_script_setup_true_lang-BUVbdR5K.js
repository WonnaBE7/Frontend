import{b as u,o as l,h as n,m as b,d as m,i as B,F as $,l as L,p as W,q as S,a as h,w as _,r as C,t as U,n as w,u as p,k as y,f as d,s as A,T as j,e as E,g as v}from"./index-Yuy5okMT.js";const H="/header-icon.png",T=(t,e)=>{const s=t.__vccOpts||t;for(const[r,i]of e)s[r]=i;return s},q={},N={class:"w-full md:max-w-[768px] h-16 px-4 flex items-center bg-white shadow-sm fixed top-0 z-10 left-1/2 -translate-x-1/2"};function R(t,e){return l(),u("header",N,e[0]||(e[0]=[n("img",{src:H,alt:"WonnaBE Logo",class:"h-6"},null,-1)]))}const V=T(q,[["render",R]]);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const G=({size:t,strokeWidth:e=2,absoluteStrokeWidth:s,color:r,iconNode:i,name:c,class:a,...o},{slots:x})=>b("svg",{...f,width:t||f.width,height:t||f.height,stroke:r||f.stroke,"stroke-width":s?Number(e)*24/Number(t):e,class:F("lucide",...c?[`lucide-${k(P(c))}-icon`,`lucide-${k(c)}`]:["lucide-icon"]),...o},[...i.map(M=>b(...M)),...x.default?[x.default()]:[]]);/**
 * @license lucide-vue-next v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
