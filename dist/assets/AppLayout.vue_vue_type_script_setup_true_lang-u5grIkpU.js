import{g as u,o as l,b as n,p as b,d as m,h as B,F as $,j as L,q as W,s as S,c as f,w as _,r as C,t as U,n as w,u as p,l as y,a as d,x as j,T as A,m as E,e as v}from"./index-CSzjFA_i.js";const H="/header-icon.png",T=(t,e)=>{const s=t.__vccOpts||t;for(const[r,i]of e)s[r]=i;return s},q={},N={class:"w-full md:max-w-[768px] h-16 px-4 flex items-center bg-white shadow-sm fixed top-0 z-10 left-1/2 -translate-x-1/2"};function R(t,e){return l(),u("header",N,e[0]||(e[0]=[n("img",{src:H,alt:"WonnaBE Logo",class:"h-6"},null,-1)]))}const V=T(q,[["render",R]]);/**
