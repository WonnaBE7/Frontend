 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q=({size:t,strokeWidth:e=2,absoluteStrokeWidth:s,color:n,iconNode:d,name:i,class:a,...o},{slots:b})=>w("svg",{...f,width:t||f.width,height:t||f.height,stroke:n||f.stroke,"stroke-width":s?Number(e)*24/Number(t):e,class:T("lucide",...i?[`lucide-${k(N(i))}-icon`,`lucide-${k(i)}`]:["lucide-icon"]),...o},[...d.map(L=>w(...L)),...b.default?[b.default()]:[]]);/**
 * @license lucide-vue-next v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
